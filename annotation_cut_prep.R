...
#formula
# 1. use the most recent twitter accounts collected (perhaps between June 15-June 30)
...
sam_500 <- rbinded_dfs[1:500,]

readr::write_excel_csv(rbinded_dfs,"june_people_full_randomised.csv")

readr::write_excel_csv(sam_500,"june_people_for_annotation.csv")
